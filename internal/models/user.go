...
func (m *UserModel) Insert(spotify_id string, display_name string, email string) (int, error) {
...
func (m *UserModel) AddRoomCode(spotify_id string, roomCode string) bool {
